          ...
          <div className="bg-white/60 backdrop-blur-2xl rounded-3xl overflow-hidden relative z-10">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <span className="text-pink-400 tracking-[0.3em] text-xs font-bold uppercase mb-2">
                  My Heart to Yours
                </span>
                <h2
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-32 -translate-y-1/2 z-20">
              <motion.div
                ...
                className="w-16 h-16 rounded-full flex items-center justify-center text-3xl shadow-lg cursor-pointer bg-gradient-to-br from-pink-400 to-purple-500 text-white border-4 border-white"
              >
                💝
              </motion.div>
            </div>

            <div className="px-8 md:px-16 pt-16 pb-24 relative">
              <div
              ...
              <p
                className={`text-lg md:text-xl lg:text-2xl leading-[2] whitespace-pre-line text-slate-700 font-light relative z-10 ${!isDone ? "typing-cursor" : ""}`}
              ...
              {isDone && (
                <motion.div
                  ...
                  className="mt-12 pt-8 border-t border-pink-100 flex flex-col md:flex-row items-center justify-between gap-4"
                >
